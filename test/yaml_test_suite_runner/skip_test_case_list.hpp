...
#ifndef FK_YAML_YAML_TEST_SUITE_RUNNER_SKIP_TEST_CASE_LIST_HPP_
#define FK_YAML_YAML_TEST_SUITE_RUNNER_SKIP_TEST_CASE_LIST_HPP_
...
// the list of test cases which contains empty keys since fkYAML deliberately unsupport them.
skip_test_case EMPTY_KEY_CASES[] = {
    {INPUT_FILE_TYPE_YAML, "2JQS", "empty keys are deliberately unsupported."},
    {INPUT_FILE_TYPE_YAML, "6M2F", "empty keys are deliberately unsupported."},
...
skip_test_case MALFORMED_INPUT_CASES[] = {
    ...
    {INPUT_FILE_TYPE_JSON, "5TYM", "malformed JSON generated from multiple YAML documents."},
    {INPUT_FILE_TYPE_JSON, "6WLZ", "malformed JSON generated from multiple YAML documents."},
    {INPUT_FILE_TYPE_JSON, "6XDY", "malformed JSON generated from multiple YAML documents."},
    {INPUT_FILE_TYPE_JSON, "6ZKB", "malformed JSON generated from multiple YAML documents."},
...
#endif /* FK_YAML_YAML_TEST_SUITE_RUNNER_SKIP_TEST_CASE_LIST_HPP_ */
