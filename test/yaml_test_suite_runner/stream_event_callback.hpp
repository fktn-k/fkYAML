...
#ifndef FK_YAML_YAML_TEST_SUITE_RUNNER_STREAM_EVENT_CALLBACK_HPP_
#define FK_YAML_YAML_TEST_SUITE_RUNNER_STREAM_EVENT_CALLBACK_HPP_
...
public:
    ...
    void on_document_end() {
        ...
        assert(m_context_stack.empty() || (m_context_stack.size() == 1 && m_context_stack.top().state & event_state::UNKNOWN));
    }
...
#endif /* FK_YAML_YAML_TEST_SUITE_RUNNER_STREAM_EVENT_CALLBACK_HPP_ */
