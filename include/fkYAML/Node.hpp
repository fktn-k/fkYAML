    ...
    union NodeValue
    {
        ...
        explicit NodeValue(NodeType type)
        {
            ...
            case NodeType::STRING:
                ...
                break;
            case NodeType::ALIAS:
                throw Exception("An alias node value must be generated by calling BasicNode::AliasOf().");
        ...
        string_type* str;
        /** A pointer to referened anchor node. */
        BasicNode* anchor;
    };
...
public:
        ...
        : m_node_type(rhs.m_node_type)
    {
        ...
        case NodeType::STRING:
            ...
            break;
        case NodeType::ALIAS:
            m_node_value.anchor = rhs.m_node_value.anchor;
            break;
        default:                                               // LCOV_EXCL_LINE
          ...
          m_anchor_name(rhs.m_anchor_name)
    {
        ...
        case NodeType::ALIAS:
            m_node_value.anchor = rhs.m_node_value.anchor;
            rhs.m_node_value.anchor = nullptr;
            break;
        default:                                             // LCOV_EXCL_LINE
            throw Exception("Unsupported node value type."); // LCOV_EXCL_LINE
        }
...
public:
    ...
    static BasicNode AliasOf(BasicNode& anchor_node)
    {
        ...
        BasicNode node;
        node.m_node_type = NodeType::ALIAS;
        node.m_node_value.anchor = &anchor_node;
        node.m_anchor_name = CreateObject<std::string>(*(anchor_node.m_anchor_name));
        return node;
    }
...
public:
    ...
    BasicNode& operator[](std::size_t index) // NOLINT(readability-make-member-function-const)
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.operator[](index);
        }
    ...
    const BasicNode& operator[](std::size_t index) const
    {
        if (m_node_type == NodeType::ALIAS)
        {
            const BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.operator[](index);
        }
    ...
    BasicNode& operator[](const std::string& key) // NOLINT(readability-make-member-function-const)
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.operator[](key);
        }
    ...
    BasicNode& operator[](std::string&& key) // NOLINT(readability-make-member-function-const)
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.operator[](std::move(key));
        }
...
public:
    ...
    bool IsEmpty() const
    {
        ...
        case NodeType::ALIAS:
            return m_node_value.anchor->IsEmpty();
        default:
    ...
    std::size_t Size() const
    {
        ...
        case NodeType::ALIAS:
            return m_node_value.anchor->Size();
        default:
            throw Exception("The target node is not of a container type.");
        }
    }
    ...
    signed_int_type& ToSignedInteger()
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.ToSignedInteger();
        }
    ...
    unsigned_int_type& ToUnsignedInteger()
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.ToUnsignedInteger();
        }
    ...
    float_number_type& ToFloatNumber()
    {
        ...
        {
            BasicNode& anchor_node = *(m_node_value.anchor);
            return anchor_node.ToFloatNumber();
        }
