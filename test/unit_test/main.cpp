...
static const std::unordered_map<unsigned long, int (*)()> TEST_CASE_MAP {
    ...
    {0x001F, NodeClassTest::MappingTypeTest},
    {0x0020, NodeClassTest::NullObjectTypeTest},
    {0x0021, NodeClassTest::BooleanTypeTest},
    {0x0022, NodeClassTest::SignedIntegerTypeTest},
    {0x0023, NodeClassTest::UnsignedIntegerTypeTest},
    {0x0024, NodeClassTest::FloatNumberTypeTest},
    {0x0025, NodeClassTest::StringTypeTest},
    {0x0026, NodeClassTest::IsSequenceTest},
    {0x0027, NodeClassTest::IsMappingTest},
    {0x0028, NodeClassTest::IsNullTest},
    {0x0029, NodeClassTest::IsBooleanTest},
    {0x002A, NodeClassTest::IsSignedIntegerTest},
    {0x002B, NodeClassTest::IsUnsignedIntegerTest},
    {0x002C, NodeClassTest::IsFloatNumberTest},
    {0x002D, NodeClassTest::IsStringTest},
    {0x002E, NodeClassTest::IsScalarTest},
    {0x002F, NodeClassTest::SequenceIsEmptyTest},
    {0x0030, NodeClassTest::MappingIsEmptyTest},
    {0x0031, NodeClassTest::StringIsEmptyTest},
    {0x0032, NodeClassTest::IsEmptyThrowExceptionTest},
    {0x0033, NodeClassTest::SequenceSizeTest},
    {0x0034, NodeClassTest::MappingSizeTest},
    {0x0035, NodeClassTest::StringSizeTest},
    {0x0036, NodeClassTest::SizeThrowExceptionTest},
    {0x0037, NodeClassTest::HasAnchorNameTest},
    {0x0038, NodeClassTest::GetAnchorNameTest},
    {0x0039, NodeClassTest::FirstAddLvalueAnchorNameTest},
    {0x003A, NodeClassTest::FirstAddRvalueAnchorNameTest},
    {0x003B, NodeClassTest::TwiceAddLvalueAnchorNameTest},
    {0x003C, NodeClassTest::TwiceAddRvalueAnchorNameTest},
    {0x003D, NodeClassTest::ToSequenceTest},
    {0x003E, NodeClassTest::ConstToSequenceTest},
    {0x003F, NodeClassTest::ToSequenceThrowExceptionTest},
    {0x0040, NodeClassTest::ToMappingTest},
    {0x0041, NodeClassTest::ConstToMappingTest},
    {0x0042, NodeClassTest::ToMappingThrowExceptionTest},
    {0x0043, NodeClassTest::ToBooleanTest},
    {0x0044, NodeClassTest::ConstToBooleanTest},
    {0x0045, NodeClassTest::ToBooleanThrowExceptionTest},
    {0x0046, NodeClassTest::ToSignedIntegerTest},
    {0x0047, NodeClassTest::ConstToSignedIntegerTest},
    {0x0048, NodeClassTest::ToSignedIntegerThrowExceptionTest},
    {0x0049, NodeClassTest::ToUnsignedIntegerTest},
    {0x004A, NodeClassTest::ConstToUnsignedIntegerTest},
    {0x004B, NodeClassTest::ToUnsignedIntegerThrowExceptionTest},
    {0x004C, NodeClassTest::ToFloatNumberTest},
    {0x004D, NodeClassTest::ConstToFloatNumberTest},
    {0x004E, NodeClassTest::ToFloatNumberThrowExceptionTest},
    {0x004F, NodeClassTest::ToStringTest},
    {0x0050, NodeClassTest::ConstToStringTest},
    {0x0051, NodeClassTest::ToStringThrowExceptionTest},
    {0x0052, NodeClassTest::SwapTest},
    {0x0053, NodeClassTest::StdSwapTest},
    {0x0054, NodeClassTest::SequenceForLoopTest},
    {0x0055, NodeClassTest::ConstSequenceForLoopTest},
