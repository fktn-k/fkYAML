...
TEST_CASE("String_Serialize_Deserialize_Roundtrip") {
    ...
    source["dash"]         = "-value";
    source["begin_space"]  = " value";
    source["end_space"]    = "value ";
    source["space"]        = " value ";
    ...
    REQUIRE(source["begin_space"] == copy["begin_space"]);
    REQUIRE(source["end_space"]   == copy["end_space"]);
    REQUIRE(source["space"]       == copy["space"]);
}
