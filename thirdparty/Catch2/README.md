This directory contains the minimum necessary files copied from the [v2.13.10](https://github.com/catchorg/Catch2/tree/v2.13.10) tag (the last version which supports C++11) to build the unit testing app for the fkYAML library.
