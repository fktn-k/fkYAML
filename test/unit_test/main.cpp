...
static const std::unordered_map<unsigned long, int (*)()> TEST_CASE_MAP {
    ...
    {0x0035, NodeClassTest::HasAnchorNameTest},
    {0x0036, NodeClassTest::GetAnchorNameTest},
    {0x0037, NodeClassTest::FirstAddLvalueAnchorNameTest},
    {0x0038, NodeClassTest::FirstAddRvalueAnchorNameTest},
    {0x0039, NodeClassTest::TwiceAddLvalueAnchorNameTest},
    {0x003A, NodeClassTest::TwiceAddRvalueAnchorNameTest},
    {0x003B, NodeClassTest::ToSequenceTest},
    {0x003C, NodeClassTest::ConstToSequenceTest},
    {0x003D, NodeClassTest::ToSequenceThrowExceptionTest},
    {0x003E, NodeClassTest::ToMappingTest},
    {0x003F, NodeClassTest::ConstToMappingTest},
    {0x0040, NodeClassTest::ToMappingThrowExceptionTest},
    {0x0041, NodeClassTest::ToBooleanTest},
    {0x0042, NodeClassTest::ConstToBooleanTest},
    {0x0043, NodeClassTest::ToBooleanThrowExceptionTest},
    {0x0044, NodeClassTest::ToSignedIntegerTest},
    {0x0045, NodeClassTest::ConstToSignedIntegerTest},
    {0x0046, NodeClassTest::ToSignedIntegerThrowExceptionTest},
    {0x0047, NodeClassTest::ToUnsignedIntegerTest},
    {0x0048, NodeClassTest::ConstToUnsignedIntegerTest},
    {0x0049, NodeClassTest::ToUnsignedIntegerThrowExceptionTest},
    {0x004A, NodeClassTest::ToFloatNumberTest},
    {0x004B, NodeClassTest::ConstToFloatNumberTest},
    {0x004C, NodeClassTest::ToFloatNumberThrowExceptionTest},
    {0x004D, NodeClassTest::ToStringTest},
    {0x004E, NodeClassTest::ConstToStringTest},
    {0x004F, NodeClassTest::ToStringThrowExceptionTest},
    {0x0050, NodeClassTest::SwapTest},
    {0x0051, NodeClassTest::StdSwapTest},
    {0x0052, NodeClassTest::SequenceForLoopTest},
    {0x0053, NodeClassTest::ConstSequenceForLoopTest},
